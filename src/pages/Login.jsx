...
const Login = () => {
  const { logInUser, setUser, signInWithGoogle, resetPassword } =
  ...
  return (
    <div
      className=" flex justify-center items-center w-11/12 mx-auto mt-8 md:mt-[60px] lg:mt-[88px]"
      data-aos="flip-left"
      data-aos-easing="ease-out-cubic"
      data-aos-duration="2000"
    >
      <div className="card bg-[#F4F3F0] w-full max-w-[500px] shrink-0 rounded-none p-5 md:px-[74px] md:py-[50px]">
        <h2 className="text-[35px] font-semibold text-center mb-5">
          Login your account
        </h2>
        ...
        <form onSubmit={handleLogin} className="card-body p-0 mt-5">
          ...
          <div className="form-control mt-2">
            ...
            <label className="label">
              <p
                ...
                className="label-text-alt md:text-lg link link-hover"
              >
                Forgot password?
              </p>
            </label>
          ...
          <div className="form-control mt-6">
            <button className="btn bg-[#D2B48C] rounded-[5px] text-black text-[20px] font-semibold hover:text-white hover:bg-[#695944]">
              Login
            </button>
          </div>
        </form>
        <div className="form-control mt-6">
          <button
            ...
            className="btn hover:bg-[#D2B48C] border-2 border-[#331A15] text-black text-[20px] font-semibold rounded-[5px]"
          >
            <FaGoogle className="text-[#331A15]"></FaGoogle> Login with Google
          </button>
        </div>
        <p className="text-center md:text-lg mt-[30px] font-semibold">
          Dont’t Have An Account ?{" "}
          <Link className="text-[#b98138]" to="/register">
            Register
          </Link>
        </p>
      </div>
