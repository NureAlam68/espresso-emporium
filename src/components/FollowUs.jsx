...
const FollowUs = () => {
    return (
        <div className="mt-10 lg:mt-[120px] px-4 lg:px-6 2xl:px-[300px]">
            ...
            <h2 className="mt-2 text-[40px] md:text-[55px] text-[#331A15] font-rancho text-center">Follow on Instagram</h2>
            <div className="mt-[30px] lg:mt-[48px] grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
                <div><img className="h-full w-full" src={itemOne} alt="" /></div>
                <div><img className="h-full w-full" src={itemTwo} alt="" /></div>
                <div><img className="h-full w-full" src={itemThree} alt="" /></div>
                <div><img className="h-full w-full" src={itemFour} alt="" /></div>
                <div><img className="h-full w-full" src={itemFive} alt="" /></div>
                <div><img className="h-full w-full" src={itemSix} alt="" /></div>
                <div><img className="h-full w-full" src={itemSeven} alt="" /></div>
                <div><img className="h-full w-full" src={itemEight} alt="" /></div>
            </div>
        </div>
    );
};
