  ...
  return (
    <div className="bg-banner bg-cover bg-center h-[60vh] lg:h-[70vh] xl:h-[800px] flex items-center justify-end px-2 md:px-[20px] xl:px-[307px]">
      <div className="lg:w-[724px] h-[224px]">
        ...
        <button className="font-rancho block mx-auto lg:flex text-[24px] lg:mx-0 bg-[#E3B577] px-[22px] py-[9px] mt-8 hover:bg-transparent hover:text-white hover:border">Learn More</button>
      </div>
    </div>
  );
};
